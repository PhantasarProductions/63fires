...
return function(combat,targettag,shirleytag,params)
   ...
   -- Data shorcuts
   local sal = gamedata.Shirley.AbsorbList    sal[target.ufil] = sal[target.ufil] or 0
   local sac = gamedata.Shirley.AbsorbCount   sac[target.ufil] = sac[target.ufil] or 0
   ...
   if success then
      ...
      combat:TagMessage(target,"Absorbed!",255,36,0)
      combat.fighters[target]=nil
      combat.foes[target]=nil
      return true
   end   
   ...
   combat.TagMessage(target,"Absorb Resisted!",255,34,0)
